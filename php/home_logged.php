...
<html>
  <head>
    ...
    <script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBS9s1LE6Qx3C7Sv4WXK-TfTgBd5e9Cew0&callback=initMap&libraries=&v=weekly"
      async
    ></script>
  </head>
  <body>
    <header>
        <div id ="overlay"></div>
        <h1 strong>Ciao <?php echo $_COOKIE["nome"]?>!</h1>
        <div class='logo'>
